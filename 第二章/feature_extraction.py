...
class DataConfig:  # data, embedding, model path etc.
    # Data Paths
    data_dir_path = "./data"
    train_path = "text.train.conll"
    test_path = "text.test.conll"

    # embedding
    embedding_file = "word_emb300.txt"
...
class Dataset(object):
    def __init__(self, model_config, train_data, test_data, feature_extractor):
...
def load_datasets(load_existing_dump=False):
    ...
    dataset = Dataset(model_config, train_data, test_data, feature_extractor)
